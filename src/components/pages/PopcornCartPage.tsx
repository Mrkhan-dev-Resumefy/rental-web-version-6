...
interface PopcornCartPageProps {
  onNavigate: (page: PageId, selectedItem?: string) => void;
}

export const PopcornCartPage: React.FC<PopcornCartPageProps> = ({ onNavigate }) => {
  return (
    <div>
      {/* ============ PAGE HERO ============ */}
        ...
        <div className="container-custom">
          <div className="product-block reverse scroll-reveal">
            <div className="gallery">
              ...
              <div className="thumb-sm">
                <img src="/assets/popcorn-3.jpg" alt="Popcorn cart wheels" />
              </div>
            </div>

            <div className="details">
              <span className="eyebrow">
                <span className="dot" /> Fan Favorite Add-On
              </span>
              <h2 style={{ marginTop: '16px' }}>Popcorn Cart</h2>
              <p className="intro">
                Freshly-popped, buttery, movie-theater-style popcorn served right at your event. The showstopper add-on that makes any birthday, movie night, or block party feel extra special.
              </p>
              ...
              <ul className="spec-list">
                <li><span className="k">Cart &amp; popper</span><span className="v">Classic red vintage-style cart with popcorn machine</span></li>
                <li><span className="k">Popcorn supply</span><span className="v">Serves approx. 50 guests (confirm on booking)</span></li>
                <li><span className="k">Bags &amp; napkins</span><span className="v">Included — enough for the full serving count</span></li>
                <li><span className="k">Butter &amp; salt</span><span className="v">Included</span></li>
              ...
              <div className="contact-row" style={{ marginBottom: '20px' }}>
                ...
                <a
                  href="https://wa.me/14699942172?text=Hi!%20I'd%20like%20to%20book%20the%20popcorn%20cart."
                  target="_blank"
                ...
                <button
                  onClick={() => onNavigate('contact', 'popcorn')}
              ...
              <div className="callout-note pair">
                <div className="ico" style={{ background: 'var(--sky-500)', color: 'var(--white)' }}>🎬</div>
                <div>
                  <strong>Add it to your Movie Night</strong> for the full experience — nothing beats fresh popcorn under the stars.{' '}
                  <button
